...
include \cite{friedman2001elements}, \cite{mardia1980multivariate},
and \cite{pages2014multiple}.
...
\subsubsection{Partial Triadic Analysis}
...
\subsubsection{Statico and Costatis}
...
\subsubsection{Reduced-Rank Regression}
